...
export default function SoalArray() {
  // SOAL 1: Looping 0-9 (Hasil turun ke bawah)
  const hasilSoal1: number[] = [];
  for (let i = 0; i <= 9; i++) {
    hasilSoal1.push(i);
  }

  // SOAL 2: Angka Ganjil (Hasil turun ke bawah)
  ...
  // SOAL 3: Angka Genap (Hasil turun ke bawah)
  ...
  // SOAL 7: Array Genap Sahaja (Turun ke bawah)
  ...
  // SOAL 9: Menambahkan data dengan push()
  var sayuran: string[] = [];
