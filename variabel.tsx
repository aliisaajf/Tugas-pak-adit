...
//     // total pembayaran
//     let totalpembayaran = diskon += pajak;

//     console.log(diskon);
//     console.log(pajak);

//     const outputMessage = `jadi total pembayaran menjadi ${totalpembayaran}`;
...
//   const outputMessage = `Strict Equal:  Lebih Dari: ${lebihdari} karena berbeda tipe data`;
