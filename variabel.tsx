...
export default function Svar() {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.box}><Text style={styles.title}>Soal 1</Text><Text>{outputMessage1}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 2</Text><Text>{outputMessage2}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 3</Text><Text>{outputMessage3}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 4</Text><Text>{outputMessage4}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 5</Text><Text>{outputMessage5}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 6</Text><Text>{outputMessage6}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 7</Text><Text>{outputMessage7}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 8</Text><Text>{outputMessage8}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 9</Text><Text>{outputMessage9}</Text></View>
            <View style={styles.box}><Text style={styles.title}>Soal 10</Text><Text>{outputMessage10}</Text></View>
        </ScrollView>
    );
}
